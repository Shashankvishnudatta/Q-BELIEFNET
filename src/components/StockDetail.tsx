...
import {
  BeliefBreakdownPanel,
  BeliefDeltaTicker,
  BeliefExplanationPanel,
  BeliefFallbackNotice,
  BeliefHistoryChart,
  BeliefScoreCard,
  EvidenceSourceMixPanel,
  EvidencePanel,
  EvidenceTrustPanel,
  FreshnessIndicator,
  NarrativeClustersPanel,
  ProviderStatusPanel,
} from '@/src/components/BeliefIntelligencePanels';
...
export function StockDetail() {
  ...
  useEffect(() => {
    if (activeTicker) {
      ...
      fetchBeliefSnapshot(activeTicker);
      fetchBeliefHistory(activeTicker);
    }
  }, [activeTicker, fetchBeliefHistory, fetchBeliefSnapshot, fetchStock]);
  ...
  return (
    <div className="flex flex-col h-full w-full px-4 sm:px-8 py-8 max-w-7xl mx-auto overflow-y-auto">
      {/* Header */}
      <FallbackNotice meta={stockMeta} error={stockError} />
      <BeliefFallbackNotice meta={beliefMeta} error={beliefError} />
      <motion.div 
      ...
      >
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <DataSourceBadge meta={stockMeta} />
          </div>
        </div>
      ...
      {isLoadingBelief ? (
        ...
        <div className="space-y-6 mb-6">
          <BeliefDeltaTicker delta={beliefDelta} />
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div className="xl:col-span-2">
              <BeliefScoreCard snapshot={beliefSnapshot} meta={beliefMeta} />
            </div>
            <BeliefBreakdownPanel snapshot={beliefSnapshot} />
          </div>
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <NarrativeClustersPanel snapshot={beliefSnapshot} />
            <BeliefExplanationPanel snapshot={beliefSnapshot} />
            <BeliefHistoryChart history={beliefHistory} />
          </div>
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            <EvidenceSourceMixPanel snapshot={beliefSnapshot} />
            <FreshnessIndicator snapshot={beliefSnapshot} />
            <ProviderStatusPanel snapshot={beliefSnapshot} />
            <EvidenceTrustPanel snapshot={beliefSnapshot} />
          </div>
          <EvidencePanel snapshot={beliefSnapshot} />
        </div>
      ) : null}
